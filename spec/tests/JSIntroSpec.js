...
describe("JSIntro Test Suite", function(){
    ...
    describe("JSIntro-ReverseArrayOfStrings", function(){
		...
		it("reverse of abc,cba is cba,abc", function(){

			var str = JSIntro.ReverseArrayOfStrings(["abc","cba"]);
			expect(str).toEqual(["cba","abc"]);
		});
        it("reverse of bhavani,hi,lux is inavahb,ih,xul", function(){

			var str = JSIntro.ReverseArrayOfStrings(["bhavani","hi","lux"]);
			expect(str).toEqual(["inavahb","ih","xul"]);
		});
